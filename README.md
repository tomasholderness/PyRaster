...
```python
rio.write_bands('newfile.tif', 'GTIFF', metadata['xsize'], metadata['ysize'], metadata['geotranslation'], rio.wkt_to_epsg(metadata['projection']),1, array)
```
